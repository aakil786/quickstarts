...
3. Add a module for scala
   You can copy the module definition from src/test/resources/modules.
...
6. Deploy the quickstart
     deploy  /path/to/quickstarts/hornetq-binding/target/switchyard-quickstarts-scala-0.2.0-SNAPSHOT.jar
...
imported project and select 'Configure'->'Add Scala Nature'.
